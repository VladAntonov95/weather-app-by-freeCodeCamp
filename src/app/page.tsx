...
import WeatherIcon from "@/components/WeaterIcon";
import { getDayOrNightIcon } from "@/utils/getDayorNightIcon";
import WeatherDetails from "@/components/WeatherDetails";
import { metersToKilometers } from "@/utils/metersToKiometers";
import { convertWindSpeed } from "@/utils/convertWindSpeed";
import ForecastWeathrDetaiil from "@/components/ForecastWeatherDetail";
                ...
                <div className="flex gap-4">
                  ...
                  <Container className="bg-yellow-300/80 px-6 gap-4 justify-between overflow-x-auto">
                    <WeatherDetails
                      ...
                      sunrise={format(
                        fromUnixTime(data?.city.sunrise ?? 1715135531),
                        "H:mm"
                      )}
                      sunset={format(
                        fromUnixTime(data?.city.sunset ?? 1715188495),
                        "H:mm"
                      )}
                    />
                  </Container>
